        ...
        <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div className="sm:text-center lg:text-left">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <a href={'/article/' + featuredPost.slug} className="block text-sportswriter xl:inline">{featuredPost.title}</a>
            </h1>
            ...
            <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              <div className="rounded-md shadow">
                <Link href={'/article/' + featuredPost.slug}>
                  <a className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-sportswriter hover:bg-sportswriter-700 md:py-4 md:text-lg md:px-10">
                    Read Article
                  </a>
                </Link>
              </div>
