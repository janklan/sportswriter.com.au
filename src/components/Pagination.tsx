      ...
      <div className="-mt-px w-0 flex-1 flex">
        { current > 1
          ...
          : <span className="border-t-2 border-transparent pt-4 pr-1 inline-flex items-center text-sm font-medium text-gray-300">
              <svg className="mr-3 h-5 w-5 text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fillRule="evenodd" d="M7.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l2.293 2.293a1 1 0 010 1.414z" clipRule="evenodd" />
              </svg>
              Previous
            </span>
        ...
        {pagination.map((it, i) => (
          it.excerpt
            ...
            : <Link key={i} href={link.href(it.page)} as={link.as(it.page)}>
                  <a className={'border-t-2 pt-4 px-4 inline-flex items-center text-sm ' + (it.page === current ? 'border-green-700 text-green-700 font-extrabold' : 'font-medium border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300')}>
                    {it.page}
                  </a>
                </Link>
